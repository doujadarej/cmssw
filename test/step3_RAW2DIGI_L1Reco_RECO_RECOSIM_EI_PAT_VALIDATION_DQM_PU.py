...
process.trackingPerf = cms.EDAnalyzer('TrackingPerf',
      ...
      genJetInput          = cms.InputTag('genJets'),
      genEventInfoInput    = cms.InputTag('genEventInfo'),
      LHEEventProductInput = cms.InputTag('LHEEventProduct'), 
      pfcands              = cms.InputTag('pfCandidates'),
      parametersDefiner    = cms.untracked.string('LhcParametersDefinerForTP'),
      muonInput            = cms.string('slimmedMuons'),
