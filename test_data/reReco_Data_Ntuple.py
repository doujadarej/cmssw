...
# with command line options: step3 --data --scenario pp --conditions 106X_dataRun2_v24 --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run2_2018,Configuration/DataProcessing/Utils.addMonitoring --eventcontent RECO,MINIAOD --runUnscheduled -s RAW2DIGI,L1Reco,RECO,EI,PAT --datatier RECO,MINIAO n=10 --era Run2_2018,pf_badHcalMitigation --nThreads 8 --dasquery=file dataset=/SingleMuon/Run2018B-ZMu-12Nov2019_UL2018-v2/RAW-RECO file:step3_data.root
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Run2_2018_cff import Run2_2018
from Configuration.Eras.Modifier_pf_badHcalMitigation_cff import pf_badHcalMitigation

process = cms.Process('RECOPerso',Run2_2018,pf_badHcalMitigation)
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2018B/SingleMuon/RAW-RECO/ZMu-12Nov2019_UL2018-v2/70000/C030D9D9-4090-C644-B117-195B5014F5C7.root'),
...
process.RECOoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step3_RAW2DIGI_L1Reco_RECO_EI_PAT.root'),
...
process.MINIAODoutput = cms.OutputModule("PoolOutputModule",
    ...
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('MINIAO'),
        filterName = cms.untracked.string('')
    ),
    dropMetaData = cms.untracked.string('ALL'),
    eventAutoFlushCompressedSize = cms.untracked.int32(-900),
    fastCloning = cms.untracked.bool(False),
    fileName = cms.untracked.string('step3_RAW2DIGI_L1Reco_RECO_EI_PAT_inMINIAOD.root'),
