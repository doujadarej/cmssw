...
#----------------------------------------- SEEDING LAYERS
import RecoTracker.TkSeedingLayers.SiStripLayerTriplet_cfi
siStripTripletStepSeedLayers = RecoTracker.TkSeedingLayers.SiStripLayerTriplet_cfi.SiStripLayerTriplet.clone()
...
siStripTripletStepClassifier1.mva.GBRForestLabel = 'MVASelectorIter6_13TeV'
...
siStripTripletStepClassifier2.mva.GBRForestLabel = 'MVASelectorIter0_13TeV'
...
#commented# trackingPhase1QuadProp.toReplaceWith(siStripTripletStep, siStripTripletStepClassifier1.clone(
#commented#      GBRForestLabel = 'MVASelectorTobTecStep_Phase1',
#commented#      qualityCuts = [-0.6,-0.45,-0.3],
#commented# ))


SiStripTripletStepTask = cms.Task(siStripTripletStepClusters,
...
SiStripTripletStep = cms.Sequence(SiStripTripletStepTask)
