...
_iterations = [
    ...
    Iteration("tobTecStep",
              ...
              selection=["tobTecStepClassifier1",
                         ...
                         "tobTecStep",
                         "tobTecStepSelector"]),
    Iteration("siStripTripletStep1",
              seeding=["siStripTripletStep1SeedLayers",
                       "siStripTripletStep1TrackingRegions",
                       "siStripTripletStep1HitDoublets",
                       "siStripTripletStep1HitTriplets",
                       "siStripTripletStep1Seeds"],
              selection=["siStripTripletStep1Classifier1",
                         "siStripTripletStepClassifier2",
                         "siStripTripletStep1",
                         "siStripTripletStep1Selector"]),
    Iteration("siStripTripletStep2",
              seeding=["siStripTripletStep2SeedLayers",
                       "siStripTripletStep2TrackingRegions",
                       "siStripTripletStep2HitDoublets",
                       "siStripTripletStep2HitTriplets",
                       "siStripTripletStep2Seeds"],
              selection=["siStripTripletStep2Classifier1",
                         "siStripTripletStepClassifier2",
                         "siStripTripletStep2",
                         "siStripTripletStep2Selector"]),
