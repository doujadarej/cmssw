...
def main():
    ...
    phase0 = (
        ...
        #"2016",
        #styleRun2
        "/opt/sbg/cms/ui3_data1/ddarej/BASIC/CMSSW_10_6_0/src/reco_ttbar_nopu/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root",
        "2016",
        styleRun2
    )
    phase1 = (
...
#    plotTime([files0pu_time, filespu_time, filescapu_time], "ttbar_phase0_phase1ca_vs_pu", [0, 35, 50, 70], ["2016", "2017", "2017 (CA)"], [styleRun2, stylePhase1, stylePhase1CA])
    ...
    plotColoredEff(files1.getFiles()[1], "ttbarnopu", pileup)
