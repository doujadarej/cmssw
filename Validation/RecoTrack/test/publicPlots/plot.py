...
#    plotDebug(files1_3, "ttbar_pu35_run2debug")
    ...
    plotColoredEff(files1.getFiles()[1], "ttbarnopu", pileup) #added this for testing, gives all efficiency colored plots
...
#        "legendColumns": 2,
#        "legendTransparent": True,
        "customiseBeforeLegend": lambda: effbox_dxy.Draw(),
        "drawOpt": "HIST",
    }
    plot = PlotStack()
    for it, leg in zip(iterations, legendLabels):
